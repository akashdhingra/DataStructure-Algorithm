<h2><a href="https://www.geeksforgeeks.org/problems/print-leaf-nodes-from-preorder-traversal-of-bst2657/1?page=1&company[]=Google&company[]=Facebook&category[]=Tree&category[]=Binary%20Search%20Tree&sortBy=submissions">Print leaf nodes from preorder traversal of BST</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a preorder traversal of a BST, find&nbsp;the leaf nodes of the tree without building the tree.</span></p>
